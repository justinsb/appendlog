...
public class LogFileSet {
    ...
    // public ByteBuffer find(long streamOffset) {
    // Entry<Long, LogFile> floorEntry = logFiles.floorEntry(streamOffset);
    // if (floorEntry == null) {
    // return null;
    // }
    // return floorEntry.getValue().find(streamOffset);
    // }
    ...
    // public long prepareWrite(ByteBuffer payload) {
    // long size = LogMessage.computeTotalSize(payload);
    //
    // }
}
